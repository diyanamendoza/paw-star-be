...
app.post('/api/pets', async(req, res) => {
  try {
    const data = await client.query('INSERT INTO pets (name, type, birthday, owner_id) VALUES($1, $2, $3, $4) RETURNING *', [req.body.name, req.body.type, req.body.birthday, req.userId]);
...
app.put('/api/pets/:id', async(req, res) => {
  try {
    const data = await client.query('UPDATE pets SET name=$1, birthday=$2, type=$3 WHERE id=$4 AND owner_id=$5 RETURNING *', [req.body.name, req.body.birthday, req.body.type, req.params.id, req.userId]);
